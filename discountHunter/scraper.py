...
def billa():
    ...
    for product in products:
        ...
        if len(product_prices) == 2:
            product_new_price = product_prices[1].text.strip()
            product_old_price = product_prices[0].text.strip()
        elif len(product_prices) == 1:
            product_new_price = product_prices[0].text.strip()
...
def kaufland():
    for category in kaufland_cats[:]:
        ...
        for product in products:
            ...
            try:
                product_old_price = product.select_one(".a-pricetag__old-price").text.strip()
            except AttributeError:
                product_old_price = None
            product_new_price = product.select_one(".a-pricetag__price").text.strip()
            try:
    ...
    for category in lidl_cats[:]:
        ...
        for product in products:
            ...
            try:
                ...
                product_old_price = None
            product_new_price = product.select_one(".lidl-m-pricebox__price").text.strip()
